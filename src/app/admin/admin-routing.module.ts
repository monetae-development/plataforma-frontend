        ...
        RouterModule.forChild([
            {
                path: '',
                children: [
                    { path: 'dataCollected/dcSendGridWebHooks', component: DcSendGridWebHooksComponent, data: { permission: 'Pages.Administration.DcSendGridWebHooks' } },
                    {
                        path: 'users',
                    ...
                    },
                    {
                        ...
                        loadChildren: () => import('./settings-platform/platform-settings.module').then((m) => m.PlatformSettingsModule),
                        data: { permission: 'Pages.Administration.Tenant.Settings.Platform' },
                    },
                    {
                        path: 'hostSettings',
