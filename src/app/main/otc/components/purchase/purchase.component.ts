...
@Component({
  selector: 'otc-crypto-purchase',
  templateUrl: './purchase.component.html'
})
export class OTCCryptoPurchaseComponent extends AppComponentBase implements OnInit {
  ...
  ngOnInit() {
    this.otcRequestDto.type = RequestType.Purchase;
  }
  ...
  calculateCost() {
    if (this.selectedCurrency !== undefined && this.otcRequestDto.amount) {
      this.otcRequestDto.cost = this.otcRequestDto.amount * this.selectedCurrency.salePrice;
    } else {
      this.otcRequestDto.cost = undefined;
    }
  }
  ...
  calculateAmount() {
    if (this.selectedCurrency !== undefined && this.otcRequestDto.cost) {
      this.otcRequestDto.amount = this.otcRequestDto.cost / this.selectedCurrency.salePrice;
    } else {
      this.otcRequestDto.amount = undefined;
    }
  }
  ...
  purchaseProcess() {
    ...
    abp.message.confirm(
      this.l('DescConfirmPurchase', this.selectedCurrency.key, this.otcRequestDto.cost.toLocaleString('en', format) + ' USD'),
      this.l('TitleConfirmPurchase'),
      (isConfirmed) => {
        if (isConfirmed) {
          this.processing = true;
          this.otcRequestDto.price = this.selectedCurrency.salePrice;
