...
@Component({
  selector: 'member-fiat-modal',
  templateUrl: './view-memberFiat-modal.component.html',
})
export class ViewMemberFiatModalComponent extends AppComponentBase implements OnInit {
