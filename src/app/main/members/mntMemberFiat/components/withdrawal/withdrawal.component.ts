...
@Component({
  selector: 'member-fiat-withdrawal',
  templateUrl: './withdrawal.component.html'
})
export class MntMemberFiatWithdrawalComponent extends AppComponentBase implements OnInit {
  @Output() onSave: EventEmitter<any> = new EventEmitter<any>();
  @ViewChild('memberFiatWithdrawalModal', { static: true }) modal: ModalDirective;
