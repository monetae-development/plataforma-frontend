...
import { PlataformaCommonModule } from '@shared/common/common.module';
...
import { SpinSuccessComponent } from './spin-status-formcontrols/spinSuccess.component';
import { SpinErrorComponent } from './spin-status-formcontrols/spinError.component';
