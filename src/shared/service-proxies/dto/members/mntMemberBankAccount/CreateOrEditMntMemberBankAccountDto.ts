import { ICreateOrEditMntMemberBankAccountDto } from './ICreateOrEditMntMemberBankAccountDto';
import { BankAccountStatus } from '@shared/service-proxies/enum/Members/BankAccountStatus.enum';

export class CreateOrEditMntMemberBankAccountDto implements ICreateOrEditMntMemberBankAccountDto {
    holder!: string;
    account!: string;
    ...
    constructor(data?: ICreateOrEditMntMemberBankAccountDto) {
        if (data) {
    ...
    static fromJS(data: any): CreateOrEditMntMemberBankAccountDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditMntMemberBankAccountDto();
        result.init(data);
        return result;
    }
